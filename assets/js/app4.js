...
function onBlogAdd(eve) {
    ...
    makeApiCall(POST_URL, "POST", blogObj)
       .then(data => {
        ...
        .catch(err => {
            snackBar('something went wrong while creating  blog', 'error')
        }) 
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            .then(data => {
                ...
                .catch(err => {
                    cl(err);
                    snackBar("Something went wrong while removing blog!", "error");
                })
...
function onUpdate(){
    ...
    .then(data => {
        ...
        .catch(err => snackBar(`Something went wrong while updating blog`, "error"))
}
